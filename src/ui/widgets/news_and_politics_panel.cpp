...
#include "news_and_politics_panel.h"
#include "discover_item_panel.h"

NewsAndPoliticsPanel::NewsAndPoliticsPanel(wxWindow * parent, DiscoveryPanelManager & panelManager) : wxScrolledWindow(parent) {
    mainSizer = new wxBoxSizer(wxVERTICAL);
    podcasts = panelManager.getNewsAndPoliticsPodcasts();
...
void NewsAndPoliticsPanel::setupSecondRow() {
...
void NewsAndPoliticsPanel::setupFirstRow() {
    auto * rowPanel = new wxPanel(this);
    auto * rowPanelSizer = new wxBoxSizer(wxHORIZONTAL);
